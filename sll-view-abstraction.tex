...
\item
 ...
 \quycom{We need one more for data constraints between $\intgrs$ data fields and observer registers and between $\intgrs$ data fields and $\intgrs$ data variables.}
\end{itemize}

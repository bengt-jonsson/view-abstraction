...
Thus, for each pair of compatible fragments $\frag_x$, $\frag_y$ in $\fragset$ such that $\lvarof{x} \in \pvarsat{\inat{\frag_x}}$ and $\tt y \in \pvarsat{\inat{\frag_y}}$, it is first checked whether the statement may form

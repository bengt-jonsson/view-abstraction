...
\end{itemize}
Let us describe the concrete structure of our symbolic representation.
...
Next, we describe our shape abstraction. Let a
...
\end{definition}
\bjcom{Should we really have this dot notation? It is a bit hard to read}
...
higher than 2 by the abstract element $\tt higher$. This means that
...
\item
  We use two types of fragments: {\em level 1-fragments} for
cells connected by a $\tt next[1]$-pointer, and {\em higher level-fragments} for
cells connected by a higher level pointer.
\item
  ...
  both level 1-fragments and higher level-fragments.
\item
...
\begin{itemize}
\item $\pvarsat{\inof{\frag'}} = \frag_1'.i_1.vars$,
\item $\pvarsat{\outof{\frag'}} = \frag_2'.i_2.vars$,

\item $\reachfromat{\inof{\frag'}} = \frag_1'.i_1.reachfrom$,
\item $\reachfromat{\outof{\frag'}} = \frag_2'.i_2.reachfrom$,
\item $\reachtoat{\inof{\frag'}} = \frag_1'.i_1.reachto$,
\item $\reachtoat{\outof{\frag'}} = \frag_2'.i_2.reachto$,

...
\node[rounded corners,draw,name=cell1,minimum width=24pt, minimum height=20pt] at ($(cell0.east)+(45pt,40pt)$){};
...
\node[rounded corners,draw,name=cell331B,minimum width=24pt, minimum height=20pt] at ($(cell232B.east)+(40pt,0pt)$){};

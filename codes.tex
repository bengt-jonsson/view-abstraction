...
\node(locate14)[linenum] at ($(pop-head.west)+(10pt,-10pt)$) {};
...
\node(locate-head)[linecode] at ($(top-head.east)+(143pt,8pt)$) {\scriptsize int deq(Timestamp ts):};
...
\node[linecode] at ($(rmv1.east)+(0pt,0pt)$) {\scriptsize (pred,curr) = locate(d);};
...
%%%%%%%%%% locate %%%%%%%%%%
\node(locate){};
\node(locate-head)[linecode] at ($(locate.east)+(-120pt,0pt)$) {\scriptsize locate(int v,Node* preds[], Node* succs[]):};

\node(locate-local)[linecode] at 
($(locate-head.west)+(10pt,-10pt)$) {\scriptsize local lfound, pred, curr;};

\node(locate1)[linenum,anchor=west] at ($(locate-local.west)+(0pt,-10pt)$) {};
\node[linecode] at ($(locate1.east)+(0pt,0pt)$) {\scriptsize pred = head; lfound = -1};

\node(locate2)[linenum] at ($(locate1.east)+(0pt,-10pt)$) {};
\node[linecode] at ($(locate2.east)+(0pt,0pt)$) {\scriptsize for (int i = maxHeight; i >= 1; i-\;-);};

\node(locate3)[linenum] at ($(locate2.east)+(0pt,-10pt)$) {};
\node[linecode] at ($(locate3.east)+(10pt,0pt)$) {\scriptsize curr = pred.next[i]; };

\node(locate4)[linenum] at ($(locate3.east)+(0pt,-10pt)$) {};
\node(code4)[linecode] at ($(locate4.east)+(10pt,0pt)$) {\scriptsize while (curr.val < v) };
...
\node(ctn2)[linenum] at ($(ctn-head.west)+(0pt,-10pt)$) {};
...
%%%%%%%%%% locate %%%%%%%%%%
\node(locate){};
\node(locate-head)[linecode] at ($(locate.west)+(-120pt,-10pt)$) {\scriptsize boolean find(int v, Node* preds[], Node* succs[]):};
\node[linecode] at ($(locate-head.west)+(0pt,-10pt)$)  {\scriptsize int mLevel = 0;};
\node[linecode] at ($(locate-head.west)+(0pt,-20pt)$)  {\scriptsize boolean marked = false;};
\node[linecode] at ($(locate-head.west)+(0pt,-30pt)$)  {\scriptsize boolean s;};
...
\node[linecode] at ($(locate-head.west)+(28pt,-110pt)$)  {\scriptsize      succ = curr.next[i].get(marked); };
 ...
 \node[linecode] at ($(locate-head.west)+(28pt,-130pt)$)  {\scriptsize       s = CAS(pred.next[i],curr,succ,false,false); };
...
\node[linecode] at ($(locate-head.west)+(14pt,-230pt)$)  {\scriptsize   return (curr.key == key); };
...
\node[linecode] at ($(add.east)+(7pt,-60pt)$)  {\scriptsize    bool found = find(v, preds, succs); };
...
\node[linecode] at ($(add.east)+(14pt,-100pt)$) {\scriptsize      Node* new = new Node(v, topLevel);};
...
\node[linecode] at ($(add.east)+(14pt,-170pt)$) {\scriptsize      if (!CAS(pred.next[mLevel],succ,new,false,false))};
...
\node[linecode] at ($(rmv.east)+(7pt,-70pt)$)  {\scriptsize     boolean found = find(v, preds, succs);};
...
\node[linecode] at ($(rmv.east)+(14pt,-120pt)$)  {\scriptsize        for (int i = node.topLevel; i >= mLevel+1; i-\;-)};
...
\node[linecode] at ($(rmv.east)+(14pt,-180pt)$)  {\scriptsize         bool marked = false; };
...
\node[linecode] at ($(rmv.east)+(21pt,-270pt)$)  {\scriptsize           else if marked return false; };
...
\node[linecode] at ($(cnt-head.west)+(0pt,-20pt)$)  {\scriptsize bool marked = false;};
\node[linecode] at ($(cnt-head.west)+(0pt,-30pt)$)  {\scriptsize Node* pred = head, curr = null, succ = null;};
...
\node[linecode] at ($(cnt-head.west)+(14pt,-80pt)$)  {\scriptsize      while (marked) };
...
\node[linecode] at ($(cnt-head.west)+(14pt,-110pt)$)  {\scriptsize     if (curr.key < v) };
...
\node[linecode] at ($(cnt-head.west)+(0pt,-160pt)$)  {\scriptsize return (curr.key == v); };
%%%%%%%%%%% struct %%%%%%%%%%%%%%%%
...
\node[linecode] at ($(locate-head.west)+(7pt,-110pt)$)  {\scriptsize      node2 = node1.next[level]; };
 \node[linecode] at ($(locate-head.west)+(0pt,-120pt)$)  {\scriptsize     return node1; };
...
\node[linecode] at ($(add.east)+(14pt,-200pt)$) {\scriptsize         node1 = getLock(savedNodes[i], key, i);};
...
\node[linecode] at ($(add.east)+(0pt,-260pt)$) {\scriptsize      return INSERTED;};
...
\node[linecode] at ($(rmv.east)+(7pt,-240pt)$)  {\scriptsize  node1 = getLock(savedNodes[i], key, i);};
...
\node[linecode] at ($(rmv.east)+(0pt,-310pt)$)  {\scriptsize return DELETE;};

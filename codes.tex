...
%%%%%%%%%% locate %%%%%%%%%%
\node(locate){};
\node(locate-head1)[linecode] at ($(locate.east)+(-120pt,0pt)$) {\scriptsize locate(int v,Node* preds[], Node* succs[]):};

\node(locate-local)[linecode] at 
($(locate-head1.west)+(10pt,-10pt)$) {\scriptsize local lfound, pred, curr;};
...
%\begin{pgfonlayer}{background}
% \node[code-bg,fit=(locate-head1) (code1499) (code888)]{};
% \end{pgfonlayer}

...
%%%%%%%%%% locate %%%%%%%%%%
\node(locate){};
\node(locate-head)[linecode] at ($(locate.east)+(-90pt,-10pt)$) {\scriptsize locate(e):};
...
\node(rmv-head)[linecode][font={\small\tt},anchor=west] at ($(add-head.west)+(31pt,-140pt)$)  {\scriptsize rmv(e):};

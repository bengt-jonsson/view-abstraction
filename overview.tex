...
out of the current level search loop, saving the current values of $\tt pred$ and $\tt curr$. It proceeds this way until it reaches the bottom level. \todo{I am working with add and remove methods}

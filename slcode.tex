...
\node(code161)[linecode] at ($(locate1610.east)+(14pt,0pt)$) {\scriptsize <succ,false>, <n,false>);};
...
%
\node(locate23)[linenum] at ($(locate22.east)+(0pt,-10pt)$) {\scriptsize 21};
...
\node(bot)[linecode] at ($(locate25.east)+(0pt,-10pt)$) {};
\begin{pgfonlayer}{background}
 \node[code-bg,fit=(locate-head) (code3) (locate14) (code22) (bot) (code161) (code23) (A) ]{};
 \end{pgfonlayer}

...
\node(code14)[linecode] at ($(locate14.east)+(40pt,0pt)$) {\scriptsize <curr.next[i], curr.marked[i]>;};
...
\node(code10)[linecode] at ($(locate131.east)+(19pt,0pt)$) {\scriptsize <n.next[i],n.marked[i]> = };

\node(locate13)[linenum] at ($(locate131.east)+(0pt,-10pt)$) {};
\node[linecode] at ($(locate13.east)+(83pt,0pt)$) {\scriptsize  <succ[i],false>;};
...
\node(code230)[linecode] at ($(locate230.east)+(27pt,0pt)$) {\scriptsize \textbf{if} CAS(<pred.next[i],pred.marked};

\node(locate23)[linenum] at ($(locate230.east)+(0pt,-10pt)$) {};
\node(code23)[linecode] at ($(locate23.east)+(40pt,0pt)$) {\scriptsize [i]>,<succ,n>,<false,false>)};

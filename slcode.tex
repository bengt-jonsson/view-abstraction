...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ADD%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\node(locate-head)[linecode] at ($(top.west)+(54pt,-15pt)$) {\scriptsize \textbf{boolean} {add} (\textbf{int} x):};
%
\node(locate1)[linenum,anchor=west] at ($(locate-head.west)+(0pt,-10pt)$) {\scriptsize 1};
...
\node(code10)[linecode] at ($(locate131.east)+(19pt,0pt)$) {\scriptsize <n.next[i],n.marked[i]> = <succ[i],false>;};

%\node(locate13)[linenum] at ($(locate131.east)+(0pt,-10pt)$) {};
%\node[linecode] at ($(locate13.east)+(53pt,0pt)$) {\scriptsize  <succ, false>;};

\node(locate14)[linenum] at ($(locate131.east)+(0pt,-10pt)$) {\scriptsize 10};

...
\node(locate161)[linenum] at ($(locate15.east)+(0pt,-10pt)$) {\scriptsize 13};
...
\node(locate161)[linenum] at ($(locate16.east)+(0pt,-10pt)$) {\scriptsize 14};
...
\node(locate17)[linenum] at ($(locate161.east)+(0pt,-10pt)$) {\scriptsize 15};

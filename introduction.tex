...
of sets, stacks, and queues, which emply singly-linked lists, skiplists, or
...
on user annotation of how linearization points are placed in each method, which
is a small burden for the verifier.
...
and of observers for specifying linearizability. The fragment abstraction
is described for singly-linked in Section~\ref{sec:fragment-abstraction},
for skiplists in Section~\ref{sect:skiplists}, and for arrays of
singly-linked lists in Section~\ref{sect:ts}. Our implementation and

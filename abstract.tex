...
A major challenge in automated verification is
is to develop techniques that are
...
arrays of timestamped singly-linked lists, which are known to us in the literature.
\end{abstract}

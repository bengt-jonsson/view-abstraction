...
\node[linecode] at ($(locate6.east)+(7pt,0pt)$) {\scriptsize \textbf{for}(\textbf{int} i=0; i<maxThreads; i++)};
...
\node(init2)[linecode] at ($(top-head.east)+(-30pt,-90pt)$) {\scriptsize \textbf{for}(\textbf{int} i=0; i<maxThreads; i++)};

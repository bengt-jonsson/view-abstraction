...
\todo[inline]{Bouajjani et al. use {\em method events} instead of {\em operation}}
...
%
A thread $\thread$ induces a labeled transition relation $\movesto\thread{}$
...
\todo[inline]{Now call and return actions are used before they are defined. Fix}
